...
public class RpcChannel implements ChannelListener {
    ...
    /**
     * 发送消息并等待响应.
     * @param destination Member[] - 目标, 以及要求回复的成员
     * @param message Serializable - 要发送的消息
     * @param rpcOptions int - FIRST_REPLY, MAJORITY_REPLY or ALL_REPLY
     * @param channelOptions channel 发送者选项
     * @param timeout long - 超时时间, 毫秒, 如果在此期间没有收到答复, 返回 null
     * @return Response[] - 响应对象数组.
     * @throws ChannelException 发送消息错误
     */
