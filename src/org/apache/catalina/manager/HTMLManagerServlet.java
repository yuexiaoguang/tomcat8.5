...
* <p>
* <code>ManagerServlet</code>和这个Servlet之间的差异是这个Servlet打印出一个HTML界面，使它更易于管理.
* <p>
* 但是，如果使用解析<code>ManagerServlet</code>输出的软件，将无法升级到该Servlet， 因为输出和<code>ManagerServlet</code>的格式不一样
*/
public final class HTMLManagerServlet extends ManagerServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        // 标识需要的请求参数
        // 通过从pathInfo获取命令, 每个命令安全性可以在 web.xml中配置
    ...
    /**
     * 从指定的Web应用程序存档中部署指定路径的应用程序.
     *
     * @param config 要部署的上下文配置文件的URL
     * @param cn 要部署的应用程序的名称
     * @param war 要部署的Web应用程序归档的URL
     * @param smClient 国际化字符串
     * 
     ...
     * 处理会话操作.
     *
     * @param cn 会话操作的应用程序的名称
     * @param req Servlet请求
     * @param resp Servlet响应
     * @param smClient 客户端区域的StringManager
     * 
     * @throws ServletException 传播的Servlet错误
     * @throws IOException 发生的IO错误
     */
     ...
     * 从HttpSession删除一个属性
     * 
     * @param cn 要从中删除属性的会话的应用程序的名称
     * @param sessionId 会话id
     * @param attributeName 属性名
     * @param smClient  客户端区域的StringManager
     * 
     * @return true 如果删除了属性, 否则false
     */
    ...
    // 这些HTML部分在比较小的部分中被破坏, 因为MessageFormat可以处理的限制数(最大为 10).
