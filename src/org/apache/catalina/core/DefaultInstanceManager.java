...
public class DefaultInstanceManager implements InstanceManager {
    ...
    /**
     * 从最深的父类到实际的类递归调用指定实例的postConstruct方法.
     *
     * @param instance 要调用postconstruct方法的对象
     * @param clazz    要检查postConstruct 注解的类.
     * 
     * @throws IllegalAccessException 如果找不到postConstruct方法.
     * @throws java.lang.reflect.InvocationTargetException 如果调用失败
     */
    ...
    /**
     * 从最深的父类到实际的类递归调用指定实例的preDestroy方法.
     *
     * @param instance 要调用preDestroy方法的对象
     * @param clazz    要检查preDestroy注解的类.
     * 
     * @throws IllegalAccessException 如果找不到preDestroy方法.
     * @throws java.lang.reflect.InvocationTargetException 如果调用失败
     */
     ...
     *
     * @param clazz         要填充注解的类
     * @param injections    从XML部署描述符到此类的注入映射
     * 
     * @throws IllegalAccessException       如果注入目标是不可访问的
     * @throws javax.naming.NamingException 如果不能在JNDI中查找值
     * @throws java.lang.reflect.InvocationTargetException 如果注入失败
     */
     ...
     * 在指定实例中注入资源.
     *
     * @param instance   要注入的实例
     * @param injections 从XML部署描述符到此类的注入映射
     * 
     * @throws IllegalAccessException       如果注入目标是不可访问的
     * @throws javax.naming.NamingException 如果在JNDI中找不到值
     * @throws java.lang.reflect.InvocationTargetException 如果注入失败
     */
     ...
     * 在指定字段中注入资源.
     *
     * @param context  从中提取值的JNDI上下文
     * @param instance 要注入的对象
     * @param field    要注入的目标字段
     * @param name     要绑定的jndi名称
     * @param clazz    定义的类注解
     * 
     * @throws IllegalAccessException       如果字段不可访问
     * @throws javax.naming.NamingException 如果在命名上下文中不可访问值
     */
     ...
     * @param context  从中提取值的JNDI上下文
     * @param instance 要注入的对象
     * @param method   要注入的目标字段
     * @param name     要绑定的jndi名称
     * @param clazz    定义的class注解
     * 
     * @throws IllegalAccessException       如果字段不可访问
     * @throws javax.naming.NamingException 如果在命名上下文中不可访问值
     * @throws java.lang.reflect.InvocationTargetException 如果setter调用失败
     */
