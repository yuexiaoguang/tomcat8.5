...
/**
 * {@link PreparedStatement}得基础代理实现.
 * <p>
 * {@link PreparedStatement}接口的所有方法简单检查 {@link PreparedStatement} 是否是激活的,
 * 并调用构造方法中提供的代理上的对应的方法.
 * <p>
 * 继承 AbandonedTrace 来实现 Statement 跟踪, 并记录创建Statement的代码. 跟踪 Statement 确保创建它的 Connection 在关闭时关闭其打开的Statement.
 */
public class DelegatingPreparedStatement extends DelegatingStatement
        implements PreparedStatement {

    /**
     * @param s 委托调用的{@link PreparedStatement}.
