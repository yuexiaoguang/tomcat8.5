...
/**
 * 用于定义由{@link KeyedObjectPool}提供服务的实例的生命周期方法.
 * <p>
 * 当{@link KeyedObjectPool}委托给{@link KeyedPooledObjectFactory}时,
 * <ol>
 *  <li>
 ...
 *  </li>
 *  <li>
 *   可以在{@link #activateObject activated}实例上调用{@link #validateObject}, 以确保它们可以从池中{@link KeyedObjectPool#borrowObject borrowed}.
 *   {@link #validateObject}也可用于在{@link #passivateObject passivated}之前测试{@link KeyedObjectPool#returnObject returned}池的实例.
 *   它只会在激活的实例上调用.
 *  </li>
 *  <li>
 ...
 *  </li>
 * </ol>
 * {@link KeyedPooledObjectFactory} 必须是线程安全的.
 * {@link KeyedObjectPool} 唯一的承诺是, 对象的同一个实例不会一次传递给<code>KeyedPoolableObjectFactory</code>的多个方法.
 * <p>
...
public interface KeyedPooledObjectFactory<K,V> {
     ...
     *
     * @param key 构造对象时使用的 key
     *
     * @return {@code PooledObject}封装得可以由池服务的实例
     *
