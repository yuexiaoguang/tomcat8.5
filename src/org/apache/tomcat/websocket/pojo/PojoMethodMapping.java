...
/**
 * 对于使用{@link javax.websocket.server.ServerEndpoint}注解的 POJO类, 这个类的一个实例将创建和缓存Onxxx调用的方法处理程序、方法信息和参数信息.
 */
public class PojoMethodMapping {
    ...
    public PojoMethodMapping(Class<?> clazzPojo,
        ...
        // 如果这些方法不在clazzPojo 上，那么它们将被clazzPojo中的非注解方法重写, 应该忽略它们
