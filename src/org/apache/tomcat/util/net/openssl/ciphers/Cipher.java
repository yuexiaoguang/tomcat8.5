...
public enum Cipher {
    ...
    /* 来自SSL 3.0规范的Fortezza密码套件
     * OpenSSL和Java都没有实现这些密码，并且使用的ID与Kerberos密码使用的ID部分重叠
    // Cipher 1C
    ...
    /* 实验（现已过期）TLSv1版本的SSLv3密码.
     * Java和OpenSSL 1.1.x以后不支持. 一些早期的OpenSSL版本确实支持这些. */
    // Cipher 60
