...
public final class IntrospectionUtils {
    ...
    /**
     * 查找具有正确名称的方法, 如果找到, 调用方法 (如果参数是int或boolean，我们将之前的值转换为正确的类型) - 意味着可以 setDebug(1).
     * 
     * @param o 要设置属性的对象
     * @param name 属性名称
     * @param value 属性值
     ...
     * 
     * @param value 值
     * @param staticProp 替换属性
     * @param dynamicProp 替换属性
     * 
     * @return 替换值
     */
