...
public class ImportHandler {
    ...
    public void importPackage(String name) {
        ...
        // 包是否存在未检查,
        // a) 为了使用时的性能在JSPs(BZ 57142),
        // b) java.lang.Package.getPackage(name) 是不可靠的(BZ 57574),
        // c) 规范不需要这种检查.
    ...
    private Class<?> findClass(String name, boolean throwException) {
        ...
        // Class 必须是 public, non-abstract and not an interface
    ...
    /*
     * Marker 类被使用， 因为null 值不允许在 ConcurrentHashMap中.
     */
